...
public abstract class Product {
		...
		// 자식 클래스에서 오버라이딩하기 때문에 부모는 추상적인 메서드로 만들기만 하면된다.
		// 추상메서드가 존재하려면 추상클래스에서만 가능
		
		// 추상 클래스는 객체 생성이 불가
		// 추상 클래스는 추상 메서드를 가질 수 있는 클래스이다.
		// 추상메서드는 메모리의 크기를 얼마나 할당해야하는지 측정불가하기 때문에 객체 공간
		// 할당이 안된다.
		// 객체 공간 할당 받으려면 얼마의 메모리가 필요한지 측정이 되어야 한다.
